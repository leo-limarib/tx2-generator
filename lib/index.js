...
exports.generateTx2 = exports.generatecNF_B03 = exports.sendToTecnospeed = void 0;
 ...
 */
const sendToTecnospeed = (tx2Path, cnpj, grupo) => {
    return new Promise((resolve, reject) => {
        const form = {
            CNPJ: cnpj,
            Grupo: grupo,
 ...
 */
const generateTx2 = (caminhoTx2, dadosNota, dadosEmitente, itens, pagamento, totalizadores, tecnico) => {
